# 최댓값 구하기
# N 개 중 이웃한 a-1, a, a+1을 뽑아내서 합을 구해야해
# 3개씩 다 뽑아내서 최댓값을 비교하면 되는거지
# 하지만 a가 맨앞 [0]방에 있을 경우?는
# 하지만 a가 맨 뒤 [N-1]방에 있을 경우?




list_N = list(int(input().split()))


 hab == list_N[a]+list_N[b]+list_N[c]
if hab > max_hab
    max_hab = hab
